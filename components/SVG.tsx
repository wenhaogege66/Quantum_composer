...
const DraggableSVG: React.FC<DraggableSVGProps> = ({
  svgImage,
  onGateSelect,
}) => {
  return (
...
interface ComponentPanelProps {
  qubits: number;
  onAddGate: (gateType: string, qubitIndex: number) => void;
}

const ComponentPanel = ({ qubits, onAddGate }: ComponentPanelProps) => {
